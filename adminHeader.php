...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/adminHeader_style.css">
		...
		<div class="maindiv">
			...
			<div class="listdiv">
            	...
            	<ul class="list">
             		...
             		<li> <a href="registerAsDoctor.php">Add Doctors</a> </li>
             		...
             		<li> <a href="">Delete Account</a>
             			...
             			<ul>
             				...
             				<li> <a href="deletePatientByAdmin.php">Delete Patient</a></li>
             				<li> <a href="deleteDoctorByAdmin.php">Delete Doctor</a>
