...
<center>
	<?php include 'patientPersonalHeader.php';?>
	<body>
		<div class="maindiv3">
...
if(isset($_POST['submit']))
{
	...
	$query1="DELETE FROM `patients_table` WHERE `email`='$email1' AND `password`='$password1'";
	$query2 = "SELECT * FROM `patients_table` WHERE `email`='$email1' AND `password`='$password1'";
...
<?php*/
		header('Location:logoutAsPatient.php?app2="login2"');
	}

	else
	{
		header('Location:deletePatient.php?error=yes');
	}
}
