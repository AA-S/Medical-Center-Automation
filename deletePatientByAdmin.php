...
<center>
	...
	<body>
		<div class="maindiv3">
			...
			<form action="deletePatientByAdmin.php" method="POST">
				...
				<?php 
					...
					if(isset($_GET['error']) && $_GET['error']=='yes')
					{
						?>
						<br>
							<h3 style="color:red;">Your E-mail is not found<br>Try again"</h3>
						<?php
					}
...
if(isset($_POST['submit']))
{
	...
	$query1="DELETE FROM `patients_table` WHERE `email`='$email1'";
	$query2 = "SELECT * FROM `patients_table` WHERE `email`='$email1'";
...
<?php
		//header('Location:logoutAsPatient.php');
	}

	else
	{
		header('Location:deletePatientByAdmin.php?error=yes');
	}
}
